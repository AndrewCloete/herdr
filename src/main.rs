...
# last_pane_local = ""    # optional, unset by default; last pane within the current workspace only
# last_tab = ""           # optional, unset by default; toggles the previous tab in the current workspace (tmux last-window)
# last_workspace = ""     # optional, unset by default; toggles the previous workspace (tmux switch-client -l)
