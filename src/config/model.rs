...
pub struct KeysConfig {
    ...
    /// Open the agent navigation panel. Unset by default.
    ...
    /// Focus the last focused pane within the current workspace only. Unset by default.
    pub last_pane_local: BindingConfig,
    /// Focus the previously active tab within the current workspace. Unset by default.
    pub last_tab: BindingConfig,
    /// Focus the previously active workspace. Unset by default.
...
pub(crate) struct KeysConfigOverlay {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    last_pane_local: Option<BindingConfig>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl Default for KeysConfig {
    fn default() -> Self {
        Self {
            ...
            last_pane_local: BindingConfig::empty(),
